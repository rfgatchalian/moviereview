    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('genre_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.genres.index") }}" class="nav-link {{ request()->is("admin/genres") || request()->is("admin/genres/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-video">

                            </i>
                            <p>
                                {{ trans('cruds.genre.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
                @can('movie_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.movies.index") }}" class="nav-link {{ request()->is("admin/movies") || request()->is("admin/movies/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-film">
