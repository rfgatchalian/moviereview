    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.movies.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('genres') ? 'is-invalid' : '' }}" name="genres[]" id="genres" multiple>
                    @foreach($genres as $id => $genre)
                        <option value="{{ $id }}" {{ in_array($id, old('genres', [])) ? 'selected' : '' }}>{{ $genre }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cast') ? 'is-invalid' : '' }}" type="text" name="cast" id="cast" value="{{ old('cast', '') }}">
                @if($errors->has('cast'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('trailer') ? 'is-invalid' : '' }}" type="text" name="trailer" id="trailer" value="{{ old('trailer', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('director') ? 'is-invalid' : '' }}" type="text" name="director" id="director" value="{{ old('director', '') }}">
